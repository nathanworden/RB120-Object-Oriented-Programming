# Rubocop File
# For this lesson, and the rest of this course, you can use the following Rubocop configuration. Remember to save it as a hidden file called .rubocop.yml in the current, or a parent directory, and make sure you are using Rubocop version 0.46.0. For a refresher on how to check or change your current Rubocop version, revisit this previous Rubocop assignment.# .rubocop.yml for non-RB101 courses (3 Jan 2019)
